                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 40),
                          // Play Again Button
                          _buildAnimatedButton( // Reuse animated button (inherits themed style)
                            onPressed: () {
                              viewModel.resetTest();
                              _playSound('sounds/correct.mp3'); // Or a UI sound
                            },
                            icon: Icons.replay_rounded,
                            label: "العب مجددًا",
                            color: theme.primaryColor, // Use theme primary for main action
                             // textColor will default to theme's button text color
                          ),
                        ],
                      ),
                    ),
